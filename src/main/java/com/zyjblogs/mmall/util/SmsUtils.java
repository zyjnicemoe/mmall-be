...
public class SmsUtils
{
    ...
    public static SendSmsResponse sendSms(String valcode, String time, String[] phoneNumbers ) {
...
//            String[] phoneNumbers = {"+8621212313123", "+8612345678902", "+8612345678903"};
            ...
            /* 模板参数: 若无模板参数，则设置为空*/
            String[] templateParams = {valcode,time};
    ...
    public static void main(String[] args) {
        ...
        SmsUtils.sendSms("1234","5", new String[] {"8613476152541"});
    }
